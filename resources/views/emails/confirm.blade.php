...
<body>
<center class="wrapper" data-link-color="#1188E6" data-body-style="font-size: 14px; font-family: arial; color: #000000; background-color: #0F0525;">
    <div class="webkit">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="wrapper" bgcolor="#0F0525">
            <tr>
                <td valign="top" bgcolor="#0F0525" width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width:600px;" align="center">
                                                <tr>
                                                    <td role="modules-container" style="padding: 0px 0px 0px 0px; color: #000000; text-align: left;" bgcolor="#0f0525" width="100%" align="left">
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                            <tr>
                                                                <td style="padding:5px 5px 5px 5px;line-height:15px;text-align:inherit;"
                                                                    height="100%"
                                                                    valign="top"
                                                                    bgcolor="">
                                                                    <div style="text-align: center;"><span style="font-size:20px;"><span style="color:#FFFFFF;">Hello!</span></span></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table  border="0"
                                                            ...
                                                            <tr role='module-content'>
                                                                <td height="100%" valign="top">
                                                                    ...
                                                                    <table  width="260.000"
                                                                            style="width:260.000px;border-spacing:0;border-collapse:collapse;margin:0px 20px 0px 0px;"
                                                                            cellpadding="0"
                                                                            cellspacing="0"
                                                                            align="left"
                                                                            border="0"
                  ...
                  empty"
                                                                    >
                                                                        <tr>
                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                ...
                                                                                <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                    <tr>
                                                                                        <td style="font-size:6px;line-height:10px;padding:45px 20px 30px 20px;" valign="top" align="center">
                                                                    ...
                                                                    <table  width="260.000"
                                                                            style="width:260.000px;border-spacing:0;border-collapse:collapse;margin:0px 0px 0px 20px;"
                                                                            cellpadding="0"
                                                                            cellspacing="0"
                                                                            align="left"
                                                                            border="0"
                                                                    ...
                                                                    >
                                                                        <tr>
                                                                            <td style="padding:0px;margin:0px;border-spacing:0;">
                                                                                ...
                                                                                <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                    <tr>
                                                                                        <td style="padding:5px 5px 5px 5px;line-height:18px;text-align:inherit;"
                                                                                            height="100%"
                                                                                            valign="top"
                                                                                            bgcolor="">
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                            <tr>
                                                                <td style="padding:5px 10px 10px 10px;line-height:15px;text-align:inherit;"
                                                                    ...
                                                                    valign="top"
                                                                    bgcolor="">
                                                                    <div style="text-align: center;"><span style="font-size:15px;"><span style="color:#FFFFFF;">We look forward seeing you in our casino</span></span></div>
                                                                </td>
                                                            </tr>
                                                        </table>
