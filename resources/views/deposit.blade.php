        ...
        <div class="cabinet-entry">
            <div class="main-content">
                <div class="page-heading">
                    ...
                    <span class="sub-text">{{translate('Would you like a BONUS on your next deposit?')}}</span>
                    <a href="{{route('bonus')}}" class="bonuses-btn">{{translate('Open Bonuses')}}</a>
                </div>
                    ...
                    <div class="deposit-entry">
                        ...
                        <div class="left-content">
                            <div class="text-block">
                                <p class="descr">{{translate('Minimum deposit is 1 mBTC')}}</p>
                                <p class="descr">(1 BTC = 1000 mBTC)</p>

                                <p class="descr">{{translate('Send your Bitcoins to this address:')}}</p>
                            </div>
                            <span class="generated-key">{{$bitcoin_address}}</span>
                        </div>
                        <div class="qr-code">
                            <img class="rounded" src="https://chart.googleapis.com/chart?chs=201x204&cht=qr&chl={{$bitcoin_address}}&choe=UTF-8" alt="qr">
                        </div>
                    </div>
