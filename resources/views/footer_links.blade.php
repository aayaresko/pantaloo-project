...
<li><a href="{{route('numbers')}}" class="bonumbers">{{translate('Bet On Numbers')}}</a></li>
<li><a href="{{route('keno')}}" class="keno">{{translate('Keno')}}</a></li>
<li><a href="{{route('holdem')}}" class="poker">{{translate('Poker')}}</a></li>