                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <a href="#custom-modal" class="btn btn-primary waves-effect waves-light m-r-5 m-b-10" data-animation="fadein" data-plugin="custommodal" data-overlayspeed="200" data-overlaycolor="#36404a">Create Tracker</a>
                            <table class="table table-hover">
                                <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Name</th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">URL</th>
                                ...
                                <tbody>
                                    @foreach($trackers as $tracker)
                                        <tr>
                                            <td>{{$tracker->name}}</td>
                                            <td>
                                                {{$tracker->getLinks()->first()}} <a href="#links_{{$tracker->id}}" class="btn btn-purple btn-xs" data-animation="fadein" data-plugin="custommodal" data-overlayspeed="200" data-overlaycolor="#36404a">All</a>
                                            ...
                                            <td>
                                                <a href="#edit_{{$tracker->id}}" class="btn btn-info btn-sm btn-rounded" data-animation="fadein" data-plugin="custommodal" data-overlayspeed="200" data-overlaycolor="#36404a">Edit</a>
                                                ...
                                                <div id="edit_{{$tracker->id}}" class="modal-demo">
                                                    ...
                                                    <div class="custom-modal-text">
                                                        <form method="POST" action="{{route('agent.updateTracker', $tracker)}}">
                                                            {{csrf_field()}}
                                                            <h4>Name</h4>
