...
<li><a href="{{route('support', ['lang' => $currentLang])}}" class="support">{{ trans('casino.support') }}</a></li>
<li><a href="{{route('bonus.promo', ['lang' => $currentLang])}}" class="bonuses">{{ trans('casino.bonuses') }}</a></li>
